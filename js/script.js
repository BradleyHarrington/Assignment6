...
document.getElementById("orderValidation").disabled = true;
...
monthyear.addEventListener("change", function(event) {
    var moyrTarget = event.target;

if (moyrTarget.id == "expyear") {
    console.log(expYear.value);
    selectedYear = expYear.value;
    console.log("Year is Firing");
    var d = new Date();
    ...
    if (currentYear > selectedYear) {
        expYear.value = "year";
        expYear.style.background = 'Yellow'; 
    } else if (currentYear == expYear.value) {
        expYear.style.background = "AliceBlue";
    } else {
        expYear.style.background = 'AliceBlue';
    }
    
    
} // end of expyear target
    
if (moyrTarget.id == "expmonth") {
    console.log(expMonth.value);
    console.log("Month is Firing");
    var d = new Date();
    currentMonth = d.getMonth();
    console.log(currentMonth);
    console.log(expYear.value);
    if (currentYear == expYear.value && currentMonth > expMonth.value) {
        expMonth.style.background = "Yellow";
    }  else if (currentYear == selectedYear && currentMonth <= expMonth.value) {
        expMonth.style.background = "AliceBlue";
        document.getElementById("orderValidation").disabled = false;
    } else {
        expMonth.style.background = 'AliceBlue';
        document.getElementById("orderValidation").disabled = false;
    }
...
orderValidation.addEventListener("click", function(event) {

var subTarget = event.target;  

if (subTarget.id = "orderValidation") {
    console.log("Submit if Firing");

//if (ccNumber.style.background == 'AliceBlue' && cvvCode.style.background == 'AliceBlue' && expYear.style.background == 'AliceBlue' && expMonth.style.background == "Yellow") {
//    document.getElementById("orderValidation").disabled = true;
//}
